...
**Operator Internals:** 018 (binary injection) → 019 (upgrades) → 015 (monitoring/guards)

**User-Facing APIs:** 001 (CRD types) → 013 (TLS) → 014 (users/databases) → 016 (kubectl plugin)
