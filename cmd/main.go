...
func main() {
	...
	if err := (&controller.BackupReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		//nolint:staticcheck // BackupReconciler uses the typed EventRecorder interface.
	...
	if err := (&controller.ScheduledBackupReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
		//nolint:staticcheck // ScheduledBackupReconciler uses the typed EventRecorder interface.
